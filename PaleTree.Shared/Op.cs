...
namespace PaleTree.Shared
{
	public static class Op
	{
		...
		public const int CS_LIKE_IT = 0xB6D; // Size: 80
		public const int CS_UNLIKE_IT = 0xB6E; // Size: 16
		...
		public const int ZC_ENTER_PC = 0xC1D; // Size: 408
		...
		public const int ZC_MOVE_POS = 0xC24; // Size: 42
		...
		public const int ZC_HIT_INFO = 0xC53; // Size: 60
		...
		public const int CZ_DISPEL_DEBUFF_TOGGLE = 0xC8D; // Size: 14
		public const int CZ_JUNGTAN_TOGGLE = 0xC8E; // Size: 16
		public const int ZC_EXP_UP = 0xC8F; // Size: 14
		public const int ZC_EXP_UP_BY_MONSTER = 0xC90; // Size: 18
		public const int ZC_PC_LEVELUP = 0xC91; // Size: 14
		public const int ZC_PC_STAT_AVG = 0xC92; // Size: 30
		public const int ZC_MAX_EXP_CHANGED = 0xC93; // Size: 18
		public const int ZC_TEXT = 0xC94; // Size: 0
		public const int ZC_UPDATE_SP = 0xC95; // Size: 15
		public const int ZC_RESTORATION = 0xC96; // Size: 12
		public const int ZC_UPDATE_MHP = 0xC97; // Size: 14
		public const int CZ_DIALOG_ACK = 0xC98; // Size: 14
		public const int CZ_DIALOG_SELECT = 0xC99; // Size: 11
		public const int CZ_DIALOG_STRINGINPUT = 0xC9A; // Size: 138
		public const int ZC_DIALOG_OK = 0xC9C; // Size: 0
		public const int ZC_DIALOG_NEXT = 0xC9D; // Size: 0
		public const int ZC_DIALOG_SELECT = 0xC9E; // Size: 0
		public const int ZC_DIALOG_ITEM_SELECT = 0xC9F; // Size: 0
		public const int ZC_DIALOG_CLOSE = 0xCA0; // Size: 6
		public const int ZC_DIALOG_TRADE = 0xCA1; // Size: 39
		public const int ZC_DIALOG_COMMON_TRADE = 0xCA2; // Size: 39
		public const int ZC_DIALOG_NUMBERRANGE = 0xCA3; // Size: 0
		public const int ZC_DIALOG_STRINGINPUT = 0xCA4; // Size: 0
		public const int ZC_ADDON_MSG = 0xCA5; // Size: 0
		public const int CZ_UI_EVENT = 0xCA6; // Size: 0
		public const int ZC_PLAY_SOUND = 0xCA7; // Size: 15
		public const int ZC_STOP_SOUND = 0xCA8; // Size: 14
		public const int ZC_PLAY_MUSICQUEUE = 0xCA9; // Size: 14
		public const int ZC_STOP_MUSICQUEUE = 0xCAA; // Size: 14
		public const int ZC_PLAY_ANI = 0xCAB; // Size: 24
		public const int ZC_CHANGE_ANI = 0xCAC; // Size: 44
		public const int CZ_MOVE_CAMP = 0xCAD; // Size: 18
		public const int CZ_CAMPINFO = 0xCAE; // Size: 18
		public const int ZC_CAMPINFO = 0xCAF; // Size: 18
		public const int ZC_FIX_ANIM = 0xCB0; // Size: 14
		public const int ZC_MOVE_ANIM = 0xCB1; // Size: 12
		public const int ZC_STD_ANIM = 0xCB2; // Size: 11
		public const int ZC_PLAY_ALARMSOUND = 0xCB4; // Size: 83
		public const int ZC_STOP_ALARMSOUND = 0xCB5; // Size: 10
		public const int ZC_PLAY_EXP_TEXT = 0xCB6; // Size: 14
		public const int ZC_PLAY_NAVI_EFFECT = 0xCB7; // Size: 150
		public const int ZC_UPDATE_ALL_STATUS = 0xCB8; // Size: 26
		public const int ZC_OBJECT_PROPERTY = 0xCB9; // Size: 0
		public const int ZC_DUMP_PROPERTY = 0xCBA; // Size: 0
		public const int ZC_SHOUT = 0xCBB; // Size: 0
		public const int ZC_SHOUT_FAILED = 0xCBC; // Size: 7
		public const int CZ_EXCHANGE_REQUEST = 0xCBD; // Size: 14
		public const int ZC_EXCHANGE_REQUEST_ACK = 0xCBE; // Size: 72
		public const int ZC_EXCHANGE_REQUEST_RECEIVED = 0xCBF; // Size: 71
		public const int CZ_EXCHANGE_ACCEPT = 0xCC0; // Size: 10
		public const int CZ_EXCHANGE_DECLINE = 0xCC1; // Size: 10
		public const int ZC_EXCHANGE_DECLINE_ACK = 0xCC2; // Size: 6
		public const int ZC_EXCHANGE_START = 0xCC3; // Size: 71
		public const int CZ_EXCHANGE_OFFER = 0xCC4; // Size: 30
		public const int ZC_EXCHANGE_OFFER_ACK = 0xCC5; // Size: 0
		public const int CZ_EXCHANGE_AGREE = 0xCC6; // Size: 10
		public const int ZC_EXCHANGE_AGREE_ACK = 0xCC7; // Size: 7
		public const int CZ_EXCHANGE_FINALAGREE = 0xCC8; // Size: 10
		public const int ZC_EXCHANGE_FINALAGREE_ACK = 0xCC9; // Size: 7
		public const int CZ_EXCHANGE_CANCEL = 0xCCA; // Size: 10
		public const int ZC_EXCHANGE_CANCEL_ACK = 0xCCB; // Size: 6
		public const int ZC_EXCHANGE_SUCCESS = 0xCCC; // Size: 6
		public const int ZC_COOLDOWN_LIST = 0xCCD; // Size: 0
		public const int ZC_COOLDOWN_CHANGED = 0xCCE; // Size: 22
		public const int ZC_OVERHEAT_CHANGED = 0xCCF; // Size: 26
		public const int ZC_TEST_AGENT = 0xCD0; // Size: 18
		public const int CZ_COMMON_SHOP_LIST = 0xCD1; // Size: 10
		public const int ZC_COMMON_SHOP_LIST = 0xCD2; // Size: 8
		public const int ZC_TIME_FACTOR = 0xCD3; // Size: 10
		public const int ZC_PARTY_ENTER = 0xCD4; // Size: 0
		public const int ZC_PARTY_OUT = 0xCD5; // Size: 24
		public const int ZC_PARTY_DESTROY = 0xCD6; // Size: 15
		public const int ZC_PARTY_INFO = 0xCD7; // Size: 0
		public const int ZC_PARTY_LIST = 0xCD8; // Size: 0
		public const int ZC_PARTY_CHAT = 0xCD9; // Size: 0
		public const int ZC_PARTY_INST_INFO = 0xCDA; // Size: 0
		public const int ZC_CHANGE_EQUIP_DURABILITY = 0xCDB; // Size: 11
		public const int CZ_DIALOG_TX = 0xCDC; // Size: 0
		public const int CZ_REQ_RECIPE = 0xCDD; // Size: 0
		public const int ZC_CUSTOM_DIALOG = 0xCDE; // Size: 75
		public const int ZC_SESSION_OBJECTS = 0xCDF; // Size: 0
		public const int ZC_SESSION_OBJ_ADD = 0xCE0; // Size: 0
		public const int ZC_SESSION_OBJ_REMOVE = 0xCE1; // Size: 10
		public const int ZC_SESSION_OBJ_TIME = 0xCE2; // Size: 14
		public const int CZ_S_OBJ_VALUE_C = 0xCE3; // Size: 24
		public const int CZ_REQ_NORMAL_TX = 0xCE4; // Size: 45
		public const int ZC_COMMANDER_LOADER_INFO = 0xCE5; // Size: 0
		public const int ZC_MOVE_SINGLE_ZONE = 0xCE6; // Size: 18
		public const int ZC_BACKTO_ORIGINAL_SERVER = 0xCE7; // Size: 8
		public const int CZ_BACKTO_ORIGINAL_SERVER = 0xCE8; // Size: 12
		public const int CZ_REQ_NORMAL_TX_NUMARG = 0xCE9; // Size: 0
		public const int ZC_WIKI_LIST = 0xCEA; // Size: 0
		public const int ZC_WIKI_ADD = 0xCEB; // Size: 22
		public const int CZ_WIKI_GET = 0xCEC; // Size: 14
		public const int CZ_WIKI_RECIPE_UPDATE = 0xCED; // Size: 10
		public const int ZC_UI_OPEN = 0xCEE; // Size: 39
		public const int ZC_ENABLE_CONTROL = 0xCEF; // Size: 11
		public const int ZC_CHANGE_CAMERA = 0xCF0; // Size: 31
		public const int ZC_MONSTER_SDR_CHANGED = 0xCF1; // Size: 11
		public const int ZC_MOVE_IGNORE_COLLISION = 0xCF2; // Size: 30
		public const int ZC_CHANGE_CAMERA_ZOOM = 0xCF3; // Size: 34
		public const int ZC_PLAY_SKILL_ANI = 0xCF4; // Size: 82
		public const int ZC_PLAY_SKILL_CAST_ANI = 0xCF5; // Size: 30
		public const int CZ_REQ_ITEM_GET = 0xCF6; // Size: 14
		public const int ZC_ITEM_GET = 0xCF7; // Size: 18
		public const int CZ_GUARD = 0xCF8; // Size: 19
		public const int ZC_GUARD = 0xCF9; // Size: 19
		public const int ZC_STAMINA = 0xCFA; // Size: 10
		public const int ZC_ADD_STAMINA = 0xCFB; // Size: 10
		public const int ZC_GM_ORDER = 0xCFC; // Size: 10
		public const int ZC_MYPC_ENTER = 0xCFD; // Size: 18
		public const int ZC_LOCK_KEY = 0xCFE; // Size: 75
		public const int ZC_SAVE_INFO = 0xCFF; // Size: 6
		...
		public const int ZC_SET_LAYER = 0xD05; // Size: 10
		public const int ZC_CREATE_LAYERBOX = 0xD06; // Size: 38
		public const int ZC_RESET_BOX = 0xD07; // Size: 11
		public const int ZC_CREATE_SCROLLLOCKBOX = 0xD08; // Size: 38
		public const int ZC_REMOVE_SCROLLLOCKBOX = 0xD09; // Size: 10
		public const int CZ_DYNAMIC_CASTING_START = 0xD0A; // Size: 23
		public const int CZ_DYNAMIC_CASTING_END = 0xD0B; // Size: 19
		public const int CZ_SKILL_CANCEL_SCRIPT = 0xD0C; // Size: 10
		public const int ZC_LEAVE_TRIGGER = 0xD0D; // Size: 6
		public const int ZC_BORN = 0xD0E; // Size: 10
		public const int ZC_ACHIEVE_POINT_LIST = 0xD0F; // Size: 0
		public const int ZC_ACHIEVE_POINT = 0xD10; // Size: 18
		public const int CZ_ACHIEVE_EQUIP = 0xD11; // Size: 18
		public const int ZC_ACHIEVE_EQUIP = 0xD12; // Size: 22
		public const int CZ_CHANGE_CONFIG = 0xD13; // Size: 18
		public const int CZ_CHANGE_CONFIG_STR = 0xD14; // Size: 34
		public const int ZC_WORLD_MSG = 0xD15; // Size: 43
		public const int ZC_ENABLE_SHOW_ITEM_GET = 0xD16; // Size: 8
		public const int ZC_LOGIN_TIME = 0xD17; // Size: 14
		public const int ZC_GIVE_EXP_TO_PC = 0xD18; // Size: 42
		public const int ZC_LAYER_PC_LIST = 0xD19; // Size: 0
		public const int ZC_LAYER_PC_SOBJ_PROP = 0xD1A; // Size: 0
		public const int CZ_CUSTOM_COMMAND = 0xD1B; // Size: 26
		public const int ZC_LAYER_INFO = 0xD1C; // Size: 10
		public const int CZ_CHAT_MACRO = 0xD1D; // Size: 146
		public const int ZC_CHAT_MACRO_LIST = 0xD1E; // Size: 0
		public const int ZC_RULLET_LIST = 0xD1F; // Size: 0
		public const int ZC_QUICKSLOT_REGISTER = 0xD20; // Size: 46
		public const int CZ_QUICKSLOT_LIST = 0xD21; // Size: 0
		public const int CZ_DOUBLE_ITEM_EQUIP = 0xD22; // Size: 28
		public const int ZC_TRICK_PACKET = 0xD23; // Size: 0
		public const int ZC_COOLDOWN_RATE = 0xD24; // Size: 22
		public const int ZC_MAP_REVEAL_LIST = 0xD25; // Size: 0
		public const int CZ_MAP_REVEAL_INFO = 0xD26; // Size: 146
		public const int CZ_MAP_SEARCH_INFO = 0xD27; // Size: 55
		public const int ZC_UI_INFO_LIST = 0xD28; // Size: 0
		public const int ZC_EXEC_CLIENT_SCP = 0xD29; // Size: 0
		public const int ZC_SET_NPC_STATE = 0xD2A; // Size: 18
		public const int ZC_NPC_STATE_LIST = 0xD2B; // Size: 0
		public const int CZ_QUEST_NPC_STATE_CHECK = 0xD2C; // Size: 14
		public const int ZC_RANK_ACHIEVE_ADD = 0xD2D; // Size: 14
		public const int CZ_GET_MAP_REVEAL_ACHIEVE = 0xD2E; // Size: 10
		public const int CZ_IES_MODIFY_INFO = 0xD2F; // Size: 0
		public const int ZC_IES_MODIFY_INFO = 0xD30; // Size: 0
		public const int ZC_IES_MODIFY_LIST = 0xD31; // Size: 0
		public const int CZ_IES_REVISION_DELETE = 0xD32; // Size: 0
		public const int ZC_IES_REVISION_DELETE = 0xD33; // Size: 0
		public const int ZC_EQUIP_ITEM_REMOVE = 0xD34; // Size: 18
		public const int ZC_SOLD_ITEM_LIST = 0xD35; // Size: 0
		public const int CZ_SOLD_ITEM = 0xD36; // Size: 19
		public const int CZ_WAREHOUSE_CMD = 0xD37; // Size: 31
		public const int CZ_SWAP_ETC_INV_CHANGE_INDEX = 0xD38; // Size: 35
		public const int CZ_SORT_INV = 0xD39; // Size: 12
		public const int CZ_CAST_CONTROL_SHOT = 0xD3A; // Size: 10
		public const int ZC_PC_PROP_UPDATE = 0xD3B; // Size: 9
		public const int CZ_CLIENT_DAMAGE = 0xD3C; // Size: 14
		public const int CZ_CLIENT_ATTACK = 0xD3D; // Size: 15
		public const int ZC_SYSTEM_MSG = 0xD3E; // Size: 0
		public const int ZC_FSM_MOVE = 0xD3F; // Size: 0
		public const int CZ_QUEST_CHECK_SAVE = 0xD40; // Size: 50
		public const int CZ_SPRAY_REQ_INFO = 0xD41; // Size: 14
		public const int CZ_SPRAY_DRAW_INFO = 0xD42; // Size: 0
		public const int ZC_SPRAY_ID = 0xD43; // Size: 18
		public const int ZC_SPRAY_DRAW_INFO = 0xD44; // Size: 0
		public const int ZC_MONSTER_LIFETIME = 0xD45; // Size: 14
		public const int ZC_SPRAY_LIKE_LIST = 0xD46; // Size: 0
		public const int ZC_WIKI_COUNT_UPDATE = 0xD47; // Size: 19
		public const int ZC_WIKI_INT_PROP_UPDATE = 0xD48; // Size: 15
		public const int ZC_WIKI_BOOL_PROP_UPDATE = 0xD49; // Size: 12
		public const int CZ_REQ_WIKI_RANK = 0xD4A; // Size: 15
		public const int ZC_WIKI_RANK_LIST = 0xD4B; // Size: 0
		public const int ZC_SHARED_MSG = 0xD4C; // Size: 10
		public const int CZ_REQ_WIKI_PROP_RANK = 0xD4D; // Size: 16
		public const int CZ_GET_WIKI_REWARD = 0xD4E; // Size: 11
		public const int CZ_REQ_TX_ITEM = 0xD4F; // Size: 0
		public const int ZC_TEST_DBG = 0xD50; // Size: 0
		public const int ZC_MONSTER_DIST = 0xD51; // Size: 0
		public const int ZC_RESET_SKILL_FORCEID = 0xD52; // Size: 10
		public const int ZC_EMOTICON = 0xD53; // Size: 18
		public const int ZC_SHOW_EMOTICON = 0xD54; // Size: 18
		public const int ZC_TREASUREMARK_BY_MAP = 0xD55; // Size: 0
		public const int ZC_SHOW_MAP = 0xD56; // Size: 0
		public const int CZ_FLEE_OBSTACLE = 0xD57; // Size: 26
		public const int ZC_HOLD_MOVE_PATH = 0xD58; // Size: 11
		public const int ZC_ENTER_HOOK = 0xD59; // Size: 10
		public const int ZC_LEAVE_HOOK = 0xD5A; // Size: 10
		public const int ZC_MONSTER_PROPERTY = 0xD5B; // Size: 0
		public const int ZC_GROUND_EFFECT = 0xD5C; // Size: 50
		public const int ZC_FLY = 0xD5D; // Size: 18
		public const int ZC_FLY_MATH = 0xD5E; // Size: 22
		public const int ZC_FLY_HEIGHT = 0xD5F; // Size: 14
		public const int ZC_UPDATE_SHIELD = 0xD60; // Size: 12
		public const int ZC_UPDATE_MSHIELD = 0xD61; // Size: 12
		public const int ZC_SHOW_MODEL = 0xD62; // Size: 15
		public const int ZC_SKILL_RANGE_DBG = 0xD63; // Size: 58
		public const int ZC_SKILL_RANGE_FAN = 0xD64; // Size: 40
		public const int ZC_SKILL_RANGE_SQUARE = 0xD65; // Size: 40
		public const int ZC_SKILL_RANGE_CIRCLE = 0xD66; // Size: 28
		public const int ZC_SKILL_RANGE_DONUTS = 0xD67; // Size: 32
		public const int ZC_TEAMID = 0xD68; // Size: 11
		public const int ZC_PC = 0xD69; // Size: 0
		public const int CZ_LOG = 0xD6A; // Size: 0
		public const int ZC_MOTIONBLUR = 0xD6B; // Size: 11
		public const int ZC_PLAY_FORCE = 0xD6C; // Size: 78
		public const int ZC_CAST_TARGET = 0xD6D; // Size: 14
		public const int ZC_START_INFO = 0xD6E; // Size: 0
		public const int ZC_JOB_EXP_UP = 0xD6F; // Size: 10
		public const int ZC_JOB_PTS = 0xD70; // Size: 10
		public const int ZC_MON_STAMINA = 0xD71; // Size: 22
		public const int CZ_CUSTOM_SCP = 0xD72; // Size: 14
		public const int ZC_VIEW_FOCUS = 0xD73; // Size: 24
		public const int ZC_HARDCODED_SKILL = 0xD74; // Size: 26
		public const int CZ_HARDCODED_SKILL = 0xD75; // Size: 34
		public const int ZC_FORCE_MOVE = 0xD76; // Size: 30
		public const int ZC_HSKILL_CONTROL = 0xD77; // Size: 22
		public const int ZC_CANCEL_DEADEVENT = 0xD78; // Size: 10
		public const int ZC_ACTION_PKS = 0xD79; // Size: 35
		public const int CZ_HARDCODED_ITEM = 0xD7A; // Size: 22
		public const int CZ_CANCEL_TRANSFORM_SKILL = 0xD7B; // Size: 10
		public const int CZ_BRIQUET = 0xD7C; // Size: 30
		public const int ZC_VIBRATE = 0xD7D; // Size: 30
		public const int ZC_COUNTER_MOVE = 0xD7E; // Size: 10
		public const int CZ_COUNTER_ATTACK = 0xD7F; // Size: 14
		public const int CZ_CLIENT_DIRECT = 0xD80; // Size: 30
		public const int ZC_CLIENT_DIRECT = 0xD81; // Size: 30
		public const int ZC_OWNER = 0xD82; // Size: 14
		public const int ZC_GD_RANK = 0xD83; // Size: 10
		public const int CZ_RUN_BGEVENT = 0xD84; // Size: 74
		public const int ZC_ADD_SKILL_EFFECT = 0xD85; // Size: 18
		public const int ZC_ITEM_DROPABLE = 0xD86; // Size: 10
		public const int CZ_ITEM_DROP_TO_OBJECT = 0xD87; // Size: 26
		public const int ZC_NORMAL = 0xD88; // Size: 0
		public const int CZ_G_QUEST_CHECK = 0xD89; // Size: 14
		public const int ZC_MOVE_PATH_MATH = 0xD8A; // Size: 30
		public const int CZ_MYPAGE_COMMENT_ADD = 0xD8B; // Size: 278
		public const int CZ_MYPAGE_COMMENT_DELETE = 0xD8C; // Size: 18
		public const int CZ_GUESTPAGE_COMMENT_ADD = 0xD8D; // Size: 278
		public const int CZ_GET_TARGET_MYPAGE = 0xD8E; // Size: 14
		public const int CZ_ON_MYPAGE_MODE = 0xD8F; // Size: 14
		public const int CZ_RESET_SOCIAL_MODE = 0xD90; // Size: 10
		public const int CZ_GET_TARGET_GUESTPAGE = 0xD91; // Size: 14
		public const int CZ_ADD_SELLMODE_ITEM = 0xD92; // Size: 30
		public const int CZ_DELETE_SELLMODE_ITEM = 0xD93; // Size: 18
		public const int CZ_ON_SELLITEM_MODE = 0xD94; // Size: 14
		public const int ZC_MYPAGE_MAP = 0xD95; // Size: 0
		public const int ZC_GUESTPAGE_MAP = 0xD96; // Size: 0
		public const int ZC_ON_MYPAGE_MODE = 0xD97; // Size: 0
		public const int ZC_RESET_SOCIAL_MODE = 0xD98; // Size: 10
		public const int CZ_ON_ITEMBUY_MODE = 0xD99; // Size: 0
		public const int ZC_ON_BUYITEM_MODE = 0xD9A; // Size: 0
		public const int ZC_SHOW_GROUND_ITEM_MARK = 0xD9B; // Size: 30
		public const int ZC_HELP_LIST = 0xD9C; // Size: 0
		public const int ZC_HELP_ADD = 0xD9D; // Size: 11
		public const int CZ_CLIENT_HIT_LIST = 0xD9E; // Size: 0
		public const int ZC_PC_ATKSTATE = 0xD9F; // Size: 11
		public const int CZ_HELP_READ_TYPE = 0xDA0; // Size: 18
		public const int CZ_MOVE_PATH_END = 0xDA1; // Size: 10
		public const int ZC_COLL_DAMAGE = 0xDA2; // Size: 11
		public const int CZ_KEYBOARD_BEAT = 0xDA3; // Size: 10
		public const int CZ_MOVEHIT_SCP = 0xDA4; // Size: 22
		public const int ZC_SYNC_START = 0xDA5; // Size: 10
		public const int ZC_SYNC_END = 0xDA6; // Size: 14
		public const int ZC_SYNC_EXEC = 0xDA7; // Size: 10
		public const int ZC_SYNC_EXEC_BY_SKILL_TIME = 0xDA8; // Size: 18
		public const int CZ_STOP_TIMEACTION = 0xDA9; // Size: 11
		public const int CZ_REQ_DUMMYPC_INFO = 0xDAA; // Size: 18
		public const int CZ_VISIT_BARRACK = 0xDAB; // Size: 74
		public const int CZ_SPC_SKILL_POS = 0xDAC; // Size: 22
		public const int CZ_REQ_CHANGEJOB = 0xDAD; // Size: 14
		public const int CZ_CHANGE_HEAD = 0xDAE; // Size: 14
		public const int CZ_CREATE_ARROW_CRAFT = 0xDAF; // Size: 14
		public const int CZ_REQ_MINITEXT = 0xDB0; // Size: 266
		public const int ZC_PC_MOVE_STOP = 0xDB1; // Size: 35
		public const int CZ_STOP_ALLPC = 0xDB2; // Size: 10
		public const int CZ_COMPLETE_PRELOAD = 0xDB3; // Size: 14
		public const int CZ_MGAME_JOIN_CMD = 0xDB4; // Size: 46
		public const int CZ_ADD_HELP = 0xDB5; // Size: 14
		public const int ZC_ATTACH_TO_OBJ = 0xDB6; // Size: 49
		public const int ZC_DETACH_FROM_OBJ = 0xDB7; // Size: 14
		public const int ZC_RUN_FROM = 0xDB8; // Size: 14
		public const int ZC_LOOKAT_OBJ = 0xDB9; // Size: 14
		public const int CZ_SKILL_CELL_LIST = 0xDBA; // Size: 0
		public const int CZ_SKILL_TOOL_GROUND_POS = 0xDBB; // Size: 26
		public const int CZ_DIRECTION_PROCESS = 0xDBC; // Size: 18
		public const int CZ_DIRECTION_MOVE_STATE = 0xDBD; // Size: 0
		public const int ZC_TO_ALL_CLIENT = 0xDBE; // Size: 0
		public const int ZC_TO_CLIENT = 0xDBF; // Size: 0
		public const int CZ_REWARD_CMD = 0xDC0; // Size: 14
		public const int CZ_PROPERTY_COMPARE = 0xDC1; // Size: 15
		public const int ZC_PROPERTY_COMPARE = 0xDC2; // Size: 0
		public const int ZC_FACTION = 0xDC3; // Size: 14
		public const int ZC_BEGIN_KILL_LOG = 0xDC4; // Size: 6
		public const int ZC_END_KILL_LOG = 0xDC5; // Size: 6
		public const int ZC_CLEAR_KILL_LOG = 0xDC6; // Size: 6
		public const int CZ_NPC_AUCTION_CMD = 0xDC7; // Size: 30
		public const int ZC_DIRECTION_APC = 0xDC8; // Size: 22
		public const int ZC_BGMODEL_ANIM_INFO = 0xDC9; // Size: 15
		public const int ZC_ATTACH_BY_KNOCKBACK = 0xDCA; // Size: 38
		public const int CZ_OBJECT_MOVE = 0xDCB; // Size: 30
		public const int CZ_CONTROL_OBJECT_ROTATE = 0xDCC; // Size: 22
		public const int CZ_SUMMON_COMMAND = 0xDCD; // Size: 18
		public const int CZ_VEHICLE_RIDE = 0xDCE; // Size: 15
		public const int CZ_REQ_WIKI_CATEGORY_RANK_PAGE_INFO = 0xDCF; // Size: 78
		public const int CZ_REQ_ACHIEVE_RANK_PAGE_INFO = 0xDD0; // Size: 78
		public const int CZ_REQ_MONSTER_RANK_INFO = 0xDD1; // Size: 74
		public const int ZC_SPC_TRIGGER_EXEC = 0xDD2; // Size: 30
		public const int CZ_REQ_MGAME_VIEW = 0xDD3; // Size: 18
		public const int CZ_REQ_MGAME_CHAT = 0xDD4; // Size: 0
		public const int CZ_TOURNAMENT_GIFT = 0xDD5; // Size: 18
		public const int CZ_PARTY_INVITE_ACCEPT = 0xDD6; // Size: 79
		public const int CZ_PARTY_INVITE_CANCEL = 0xDD7; // Size: 83
		public const int CZ_PARTY_PROP_CHANGE = 0xDD8; // Size: 145
		public const int CZ_REQ_MARKET_REGISTER = 0xDD9; // Size: 27
		public const int CZ_REQ_MARKET_BUY = 0xDDA; // Size: 0
		public const int CZ_REQ_MARKET_LIST = 0xDDB; // Size: 162
		public const int CZ_REQ_MY_SELL_LIST = 0xDDC; // Size: 14
		public const int CZ_REQ_CABINET_LIST = 0xDDD; // Size: 10
		public const int CZ_REQ_GET_CABINET_ITEM = 0xDDE; // Size: 26
		public const int CZ_REQ_CANCEL_MARKET_ITEM = 0xDDF; // Size: 18
		public const int CZ_INV_ITEM_LOCK = 0xDE0; // Size: 19
		public const int CZ_OBJ_RECORD_POS = 0xDE1; // Size: 0
		public const int CZ_FORMATION_CMD = 0xDE2; // Size: 32
		public const int CZ_REGISTER_AUTOSELLER = 0xDE3; // Size: 0
		public const int CZ_OPEN_AUTOSELLER = 0xDE4; // Size: 34
		public const int CZ_BUY_AUTOSELLER_ITEMS = 0xDE5; // Size: 0
		public const int CZ_SELL_MY_AUTOSELLER_ITEMS = 0xDE6; // Size: 0
		public const int CZ_PUZZLE_CRAFT = 0xDE7; // Size: 0
		public const int CZ_PET_EQUIP = 0xDE8; // Size: 30
		public const int ZC_FOUND_PARTY_LIST = 0xDE9; // Size: 0
		public const int ZC_NEAR_PARTY_LIST = 0xDEA; // Size: 0
		...
		public const int CZ_ACCEPT_PARTY_QUEST = 0xDF4; // Size: 20
		public const int CZ_ACCEPT_PARTY_EVENT = 0xDF5; // Size: 20
		...
		public const int ZC_XIGNCODE_BUFFER = 0xDF9; // Size: 524
		public const int CZ_XIGNCODE_BUFFER = 0xDFA; // Size: 524
		public const int CZ_SYSTEM_LOG_SAVE_TO_MONGODB = 0xDFB; // Size: 280
		public const int CZ_CHANGE_TITLE = 0xDFC; // Size: 74
		public const int CZ_PC_COMMENT_CHANGE = 0xDFD; // Size: 0
		public const int CZ_AUTTOSELLER_BUYER_CLOSE = 0xDFE; // Size: 18
		public const int CZ_REQ_ITEM_LIST = 0xDFF; // Size: 11
		public const int CZ_HIT_MISSILE = 0xE00; // Size: 14
		public const int CZ_I_NEED_PARTY = 0xE01; // Size: 23
		public const int CZ_PARTY_JOIN_BY_LINK = 0xE02; // Size: 19
		public const int ZC_RECOMMEND_PARTYMEMBER_INFO = 0xE03; // Size: 0
		public const int CZ_PVP_ZONE_CMD = 0xE04; // Size: 22
		public const int CZ_PVP_CHAT = 0xE05; // Size: 0
		public const int CZ_CARDBATTLE_CMD = 0xE06; // Size: 26
		public const int CZ_REQ_UPDATE_CONTENTS_SESSION = 0xE07; // Size: 10
		public const int CZ_REQ_FRIENDLY_FIGHT = 0xE08; // Size: 15
		public const int CZ_CART_POSITION = 0xE09; // Size: 26
		public const int CZ_REQ_RIDE_CART = 0xE0A; // Size: 18
		public const int CZ_DUMMYPC_SKILL_POS = 0xE0B; // Size: 26
