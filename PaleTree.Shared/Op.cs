...
namespace PaleTree.Shared
{
	public static class Op
	{
		...
		public const int CZ_USE_TP_AND_ENTER_INDUN = 0xD0F; // Size: 522
		public const int ZC_SET_LAYER = 0xD10; // Size: 10
		public const int ZC_CREATE_LAYERBOX = 0xD11; // Size: 38
		public const int ZC_RESET_BOX = 0xD12; // Size: 11
		public const int ZC_CREATE_SCROLLLOCKBOX = 0xD13; // Size: 38
		public const int ZC_REMOVE_SCROLLLOCKBOX = 0xD14; // Size: 10
		public const int CZ_DYNAMIC_CASTING_START = 0xD15; // Size: 24
		public const int CZ_DYNAMIC_CASTING_END = 0xD16; // Size: 19
		public const int CZ_SKILL_CANCEL_SCRIPT = 0xD17; // Size: 10
		public const int ZC_LEAVE_TRIGGER = 0xD18; // Size: 6
		public const int ZC_BORN = 0xD19; // Size: 10
		public const int ZC_ACHIEVE_POINT_LIST = 0xD1A; // Size: 0
		public const int ZC_ACHIEVE_POINT = 0xD1B; // Size: 18
		...
		public const int ZC_WORLD_MSG = 0xD21; // Size: 43
		public const int ZC_ENABLE_SHOW_ITEM_GET = 0xD22; // Size: 8
		public const int ZC_LOGIN_TIME = 0xD23; // Size: 14
		public const int ZC_GIVE_EXP_TO_PC = 0xD24; // Size: 42
		...
		public const int ZC_LAYER_INFO = 0xD28; // Size: 10
		...
		public const int ZC_QUICKSLOT_REGISTER = 0xD2C; // Size: 46
		...
		public const int ZC_COOLDOWN_RATE = 0xD30; // Size: 22
		...
		public const int ZC_UI_INFO_LIST = 0xD34; // Size: 0
		public const int ZC_EXEC_CLIENT_SCP = 0xD35; // Size: 0
		public const int ZC_SET_NPC_STATE = 0xD36; // Size: 18
		public const int ZC_NPC_STATE_LIST = 0xD37; // Size: 0
		public const int CZ_QUEST_NPC_STATE_CHECK = 0xD38; // Size: 14
		public const int ZC_RANK_ACHIEVE_ADD = 0xD39; // Size: 14
		public const int CZ_GET_MAP_REVEAL_ACHIEVE = 0xD3A; // Size: 10
		public const int CZ_IES_MODIFY_INFO = 0xD3B; // Size: 0
		public const int ZC_IES_MODIFY_INFO = 0xD3C; // Size: 0
		public const int ZC_IES_MODIFY_LIST = 0xD3D; // Size: 0
		public const int CZ_IES_REVISION_DELETE = 0xD3E; // Size: 0
		public const int ZC_IES_REVISION_DELETE = 0xD3F; // Size: 0
		public const int ZC_EQUIP_ITEM_REMOVE = 0xD40; // Size: 18
		public const int ZC_SOLD_ITEM_LIST = 0xD41; // Size: 0
		public const int CZ_SOLD_ITEM = 0xD42; // Size: 19
		public const int CZ_WAREHOUSE_CMD = 0xD43; // Size: 31
		public const int CZ_SWAP_ETC_INV_CHANGE_INDEX = 0xD44; // Size: 35
		public const int CZ_SORT_INV = 0xD45; // Size: 12
		public const int CZ_EXTEND_WAREHOUSE = 0xD46; // Size: 10
		public const int CZ_CAST_CONTROL_SHOT = 0xD47; // Size: 10
		public const int ZC_PC_PROP_UPDATE = 0xD48; // Size: 9
		public const int CZ_CLIENT_DAMAGE = 0xD49; // Size: 14
		public const int CZ_CLIENT_ATTACK = 0xD4A; // Size: 15
		public const int ZC_SYSTEM_MSG = 0xD4B; // Size: 0
		public const int ZC_FSM_MOVE = 0xD4C; // Size: 0
		public const int CZ_QUEST_CHECK_SAVE = 0xD4D; // Size: 50
		public const int CZ_SPRAY_REQ_INFO = 0xD4E; // Size: 14
		public const int CZ_SPRAY_DRAW_INFO = 0xD4F; // Size: 0
		public const int ZC_SPRAY_ID = 0xD50; // Size: 18
		public const int ZC_SPRAY_DRAW_INFO = 0xD51; // Size: 0
		public const int ZC_MONSTER_LIFETIME = 0xD52; // Size: 14
		public const int ZC_SPRAY_LIKE_LIST = 0xD53; // Size: 0
		public const int ZC_WIKI_COUNT_UPDATE = 0xD54; // Size: 19
		public const int ZC_WIKI_INT_PROP_UPDATE = 0xD55; // Size: 15
		public const int ZC_WIKI_BOOL_PROP_UPDATE = 0xD56; // Size: 12
		public const int CZ_REQ_WIKI_RANK = 0xD57; // Size: 15
		public const int ZC_WIKI_RANK_LIST = 0xD58; // Size: 0
		public const int ZC_SHARED_MSG = 0xD59; // Size: 10
		public const int CZ_REQ_WIKI_PROP_RANK = 0xD5A; // Size: 16
		public const int CZ_GET_WIKI_REWARD = 0xD5B; // Size: 11
		public const int CZ_REQ_TX_ITEM = 0xD5C; // Size: 0
		public const int ZC_TEST_DBG = 0xD5D; // Size: 0
		public const int ZC_MONSTER_DIST = 0xD5E; // Size: 0
		public const int ZC_RESET_SKILL_FORCEID = 0xD5F; // Size: 10
		public const int ZC_EMOTICON = 0xD60; // Size: 18
		public const int ZC_SHOW_EMOTICON = 0xD61; // Size: 18
		public const int ZC_TREASUREMARK_BY_MAP = 0xD62; // Size: 0
		public const int ZC_SHOW_MAP = 0xD63; // Size: 0
		public const int CZ_FLEE_OBSTACLE = 0xD64; // Size: 26
		public const int ZC_HOLD_MOVE_PATH = 0xD65; // Size: 11
		public const int ZC_ENTER_HOOK = 0xD66; // Size: 10
		public const int ZC_LEAVE_HOOK = 0xD67; // Size: 10
		public const int ZC_MONSTER_PROPERTY = 0xD68; // Size: 0
		public const int ZC_GROUND_EFFECT = 0xD69; // Size: 50
		public const int ZC_FLY = 0xD6A; // Size: 18
		public const int ZC_FLY_MATH = 0xD6B; // Size: 22
		public const int ZC_FLY_HEIGHT = 0xD6C; // Size: 14
		public const int ZC_UPDATE_SHIELD = 0xD6D; // Size: 14
		public const int ZC_SHOW_MODEL = 0xD6E; // Size: 15
		public const int ZC_SKILL_RANGE_DBG = 0xD6F; // Size: 58
		public const int ZC_SKILL_RANGE_FAN = 0xD70; // Size: 40
		public const int ZC_SKILL_RANGE_SQUARE = 0xD71; // Size: 40
		public const int ZC_SKILL_RANGE_CIRCLE = 0xD72; // Size: 28
		public const int ZC_SKILL_RANGE_DONUTS = 0xD73; // Size: 32
		public const int ZC_TEAMID = 0xD74; // Size: 11
		public const int ZC_PC = 0xD75; // Size: 0
		public const int CZ_LOG = 0xD76; // Size: 0
		public const int ZC_MOTIONBLUR = 0xD77; // Size: 11
		public const int ZC_PLAY_FORCE = 0xD78; // Size: 78
		public const int ZC_CAST_TARGET = 0xD79; // Size: 14
		public const int ZC_START_INFO = 0xD7A; // Size: 0
		public const int ZC_JOB_EXP_UP = 0xD7B; // Size: 10
		public const int ZC_JOB_PTS = 0xD7C; // Size: 10
		public const int ZC_MON_STAMINA = 0xD7D; // Size: 22
		public const int CZ_CUSTOM_SCP = 0xD7E; // Size: 14
		public const int ZC_VIEW_FOCUS = 0xD7F; // Size: 24
		public const int ZC_HARDCODED_SKILL = 0xD80; // Size: 26
		public const int CZ_HARDCODED_SKILL = 0xD81; // Size: 34
		public const int ZC_FORCE_MOVE = 0xD82; // Size: 30
		public const int ZC_HSKILL_CONTROL = 0xD83; // Size: 22
		public const int ZC_CANCEL_DEADEVENT = 0xD84; // Size: 10
		public const int ZC_ACTION_PKS = 0xD85; // Size: 35
		public const int CZ_HARDCODED_ITEM = 0xD86; // Size: 22
		public const int CZ_CANCEL_TRANSFORM_SKILL = 0xD87; // Size: 10
		public const int CZ_BRIQUET = 0xD88; // Size: 30
		public const int ZC_VIBRATE = 0xD89; // Size: 30
		public const int ZC_COUNTER_MOVE = 0xD8A; // Size: 10
		public const int CZ_COUNTER_ATTACK = 0xD8B; // Size: 14
		public const int CZ_CLIENT_DIRECT = 0xD8C; // Size: 30
		public const int ZC_CLIENT_DIRECT = 0xD8D; // Size: 30
		public const int ZC_OWNER = 0xD8E; // Size: 14
		public const int ZC_GD_RANK = 0xD8F; // Size: 10
		public const int CZ_RUN_BGEVENT = 0xD90; // Size: 74
		public const int ZC_ADD_SKILL_EFFECT = 0xD91; // Size: 18
		public const int ZC_ITEM_DROPABLE = 0xD92; // Size: 10
		public const int CZ_ITEM_DROP_TO_OBJECT = 0xD93; // Size: 26
		public const int ZC_NORMAL = 0xD94; // Size: 0
		public const int CZ_G_QUEST_CHECK = 0xD95; // Size: 14
		public const int ZC_MOVE_PATH_MATH = 0xD96; // Size: 30
		public const int CZ_MYPAGE_COMMENT_ADD = 0xD97; // Size: 278
		public const int CZ_MYPAGE_COMMENT_DELETE = 0xD98; // Size: 18
		public const int CZ_GUESTPAGE_COMMENT_ADD = 0xD99; // Size: 278
		public const int CZ_GET_TARGET_MYPAGE = 0xD9A; // Size: 14
		public const int CZ_ON_MYPAGE_MODE = 0xD9B; // Size: 14
		public const int CZ_RESET_SOCIAL_MODE = 0xD9C; // Size: 10
		public const int CZ_GET_TARGET_GUESTPAGE = 0xD9D; // Size: 14
		public const int CZ_ADD_SELLMODE_ITEM = 0xD9E; // Size: 30
		public const int CZ_DELETE_SELLMODE_ITEM = 0xD9F; // Size: 18
		public const int CZ_ON_SELLITEM_MODE = 0xDA0; // Size: 14
		public const int ZC_MYPAGE_MAP = 0xDA1; // Size: 0
		public const int ZC_GUESTPAGE_MAP = 0xDA2; // Size: 0
		public const int ZC_ON_MYPAGE_MODE = 0xDA3; // Size: 0
		public const int ZC_RESET_SOCIAL_MODE = 0xDA4; // Size: 10
		public const int CZ_ON_ITEMBUY_MODE = 0xDA5; // Size: 0
		public const int ZC_ON_BUYITEM_MODE = 0xDA6; // Size: 0
		public const int ZC_SHOW_GROUND_ITEM_MARK = 0xDA7; // Size: 30
		public const int ZC_HELP_LIST = 0xDA8; // Size: 0
		...
		public const int CZ_KEYBOARD_BEAT = 0xDB0; // Size: 10
		public const int CZ_MOVEHIT_SCP = 0xDB1; // Size: 22
		public const int ZC_SYNC_START = 0xDB2; // Size: 10
		public const int ZC_SYNC_END = 0xDB3; // Size: 14
		public const int ZC_SYNC_EXEC = 0xDB4; // Size: 10
		public const int ZC_SYNC_EXEC_BY_SKILL_TIME = 0xDB5; // Size: 18
		public const int CZ_STOP_TIMEACTION = 0xDB6; // Size: 11
		public const int CZ_REQ_DUMMYPC_INFO = 0xDB7; // Size: 18
		public const int CZ_VISIT_BARRACK = 0xDB8; // Size: 74
		public const int CZ_SPC_SKILL_POS = 0xDB9; // Size: 22
		public const int CZ_REQ_CHANGEJOB = 0xDBA; // Size: 14
		public const int CZ_CHANGE_HEAD = 0xDBB; // Size: 74
		public const int CZ_CREATE_ARROW_CRAFT = 0xDBC; // Size: 14
		public const int CZ_REQ_MINITEXT = 0xDBD; // Size: 266
		public const int ZC_PC_MOVE_STOP = 0xDBE; // Size: 35
		public const int CZ_STOP_ALLPC = 0xDBF; // Size: 10
		public const int CZ_COMPLETE_PRELOAD = 0xDC0; // Size: 14
		public const int CZ_MGAME_JOIN_CMD = 0xDC1; // Size: 46
		public const int CZ_ADD_HELP = 0xDC2; // Size: 14
		public const int ZC_ATTACH_TO_OBJ = 0xDC3; // Size: 49
		public const int ZC_DETACH_FROM_OBJ = 0xDC4; // Size: 14
		public const int ZC_RUN_FROM = 0xDC5; // Size: 14
		public const int ZC_LOOKAT_OBJ = 0xDC6; // Size: 14
		public const int CZ_SKILL_CELL_LIST = 0xDC7; // Size: 0
		public const int CZ_SKILL_TOOL_GROUND_POS = 0xDC8; // Size: 26
		public const int CZ_DIRECTION_PROCESS = 0xDC9; // Size: 18
		public const int CZ_DIRECTION_MOVE_STATE = 0xDCA; // Size: 0
		public const int ZC_TO_ALL_CLIENT = 0xDCB; // Size: 0
		public const int ZC_TO_CLIENT = 0xDCC; // Size: 0
		public const int CZ_REWARD_CMD = 0xDCD; // Size: 14
		public const int CZ_PROPERTY_COMPARE = 0xDCE; // Size: 16
		public const int ZC_PROPERTY_COMPARE = 0xDCF; // Size: 0
		public const int ZC_FACTION = 0xDD0; // Size: 14
		public const int ZC_SEND_CASH_VALUE = 0xDD1; // Size: 0
		public const int ZC_BEGIN_KILL_LOG = 0xDD2; // Size: 6
		public const int ZC_END_KILL_LOG = 0xDD3; // Size: 6
		public const int ZC_CLEAR_KILL_LOG = 0xDD4; // Size: 6
		public const int CZ_NPC_AUCTION_CMD = 0xDD5; // Size: 30
		public const int ZC_DIRECTION_APC = 0xDD6; // Size: 26
		public const int ZC_BGMODEL_ANIM_INFO = 0xDD7; // Size: 15
		public const int ZC_ATTACH_BY_KNOCKBACK = 0xDD8; // Size: 38
		public const int CZ_OBJECT_MOVE = 0xDD9; // Size: 30
		public const int CZ_CONTROL_OBJECT_ROTATE = 0xDDA; // Size: 22
		public const int CZ_SUMMON_COMMAND = 0xDDB; // Size: 18
		public const int CZ_VEHICLE_RIDE = 0xDDC; // Size: 15
		public const int CZ_REQ_WIKI_CATEGORY_RANK_PAGE_INFO = 0xDDD; // Size: 78
		public const int CZ_REQ_ACHIEVE_RANK_PAGE_INFO = 0xDDE; // Size: 78
		public const int CZ_REQ_MONSTER_RANK_INFO = 0xDDF; // Size: 74
		public const int ZC_SPC_TRIGGER_EXEC = 0xDE0; // Size: 30
		public const int CZ_REQ_MGAME_VIEW = 0xDE1; // Size: 18
		public const int CZ_REQ_MGAME_CHAT = 0xDE2; // Size: 0
		public const int CZ_TOURNAMENT_GIFT = 0xDE3; // Size: 18
		public const int CZ_PARTY_INVITE_ACCEPT = 0xDE4; // Size: 79
		public const int CZ_PARTY_INVITE_CANCEL = 0xDE5; // Size: 83
		public const int CZ_PARTY_PROP_CHANGE = 0xDE6; // Size: 145
		public const int CZ_REQ_MARKET_REGISTER = 0xDE7; // Size: 40
		public const int CZ_REQ_MARKET_MINMAX_INFO = 0xDE8; // Size: 18
		public const int CZ_REQ_MARKET_BUY = 0xDE9; // Size: 0
		public const int CZ_REQ_MARKET_LIST = 0xDEA; // Size: 162
		public const int CZ_REQ_MY_SELL_LIST = 0xDEB; // Size: 14
		public const int CZ_REQ_CABINET_LIST = 0xDEC; // Size: 10
		public const int CZ_REQ_GET_CABINET_ITEM = 0xDED; // Size: 26
		public const int CZ_REQ_CANCEL_MARKET_ITEM = 0xDEE; // Size: 18
		public const int CZ_INV_ITEM_LOCK = 0xDEF; // Size: 19
		public const int CZ_OBJ_RECORD_POS = 0xDF0; // Size: 0
		public const int CZ_FORMATION_CMD = 0xDF1; // Size: 32
		public const int CZ_REGISTER_AUTOSELLER = 0xDF2; // Size: 0
		public const int CZ_OPEN_AUTOSELLER = 0xDF3; // Size: 34
		public const int CZ_BUY_AUTOSELLER_ITEMS = 0xDF4; // Size: 0
		public const int CZ_SELL_MY_AUTOSELLER_ITEMS = 0xDF5; // Size: 0
		public const int CZ_PUZZLE_CRAFT = 0xDF6; // Size: 0
		public const int CZ_PET_EQUIP = 0xDF7; // Size: 30
		public const int ZC_FOUND_PARTY_LIST = 0xDF8; // Size: 0
		public const int ZC_NEAR_PARTY_LIST = 0xDF9; // Size: 0
		public const int ZC_RECOMMEND_PARTY_INFO = 0xDFA; // Size: 0
		public const int CZ_REQUEST_SOME_PARTY = 0xDFB; // Size: 90
		public const int CZ_REFRESH_MEMBERRECOMMEND_LIST = 0xDFC; // Size: 10
		public const int ZC_TO_SOMEWHERE_CLIENT = 0xDFD; // Size: 0
		public const int CZ_REVEAL_NPC_STATE = 0xDFE; // Size: 14
		public const int CZ_CHANGE_CHANNEL = 0xDFF; // Size: 12
		public const int CZ_REQ_CHANNEL_TRAFFICS = 0xE00; // Size: 12
		public const int CZ_BUY_PROPERTYSHOP_ITEM = 0xE01; // Size: 0
		public const int CZ_SKILL_USE_HEIGHT = 0xE02; // Size: 14
		public const int CZ_ACCEPT_PARTY_QUEST = 0xE03; // Size: 20
		public const int CZ_ACCEPT_GUILD_EVENT = 0xE04; // Size: 20
		public const int CZ_ACCEPT_GUILD_EVENT_RAID = 0xE05; // Size: 20
		public const int CZ_ACCEPT_PARTY_EVENT = 0xE06; // Size: 20
		public const int CZ_DELETE_PARTY_EVENT = 0xE07; // Size: 20
		public const int CZ_PING = 0xE08; // Size: 10
		public const int ZC_PING = 0xE09; // Size: 10
		public const int ZC_XIGNCODE_BUFFER = 0xE0A; // Size: 524
		public const int CZ_XIGNCODE_BUFFER = 0xE0B; // Size: 524
		public const int CZ_SYSTEM_LOG_SAVE_TO_MONGODB = 0xE0C; // Size: 280
		public const int CZ_CHANGE_TITLE = 0xE0D; // Size: 74
		public const int CZ_PC_COMMENT_CHANGE = 0xE0E; // Size: 0
		public const int CZ_AUTTOSELLER_BUYER_CLOSE = 0xE0F; // Size: 18
		public const int CZ_REQ_ITEM_LIST = 0xE10; // Size: 11
		public const int CZ_HIT_MISSILE = 0xE11; // Size: 14
		public const int CZ_I_NEED_PARTY = 0xE12; // Size: 23
		public const int CZ_PARTY_JOIN_BY_LINK = 0xE13; // Size: 19
		public const int ZC_RECOMMEND_PARTYMEMBER_INFO = 0xE14; // Size: 0
		public const int CZ_PVP_ZONE_CMD = 0xE15; // Size: 22
		public const int CZ_PVP_CHAT = 0xE16; // Size: 0
		public const int CZ_CARDBATTLE_CMD = 0xE17; // Size: 26
		public const int CZ_REQ_UPDATE_CONTENTS_SESSION = 0xE18; // Size: 10
		public const int CZ_REQ_FRIENDLY_FIGHT = 0xE19; // Size: 15
		public const int CZ_HARDSKILL_POS_LIST = 0xE1A; // Size: 0
		public const int CZ_CART_POSITION = 0xE1B; // Size: 26
		public const int CZ_REQ_RIDE_CART = 0xE1C; // Size: 18
		public const int CZ_DUMMYPC_SKILL_POS = 0xE1D; // Size: 26
		public const int CZ_NGS = 0xE1E; // Size: 0
