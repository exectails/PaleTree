...
namespace PaleTree.Shared
{
	public static class Op
	{
		...
		public const int BC_COMMANDER_CREATE = 0x13; // Size: 326
		public const int BC_COMMANDER_DESTROY = 0x14; // Size: 7
		public const int BC_START_GAMEOK = 0x15; // Size: 33
		public const int BC_SINGLE_INFO = 0x16; // Size: 317
		...
		public const int CB_PET_COMMAND = 0x59; // Size: 27
		...
		public const int CB_NGS = 0x5E; // Size: 10254
		public const int ZC_TREASUREMARK_LIST_MAP = 0xCE; // Size: 0
		...
		public const int CS_REQUEST_PVP_RANKING = 0xB6A; // Size: 83
		...
		public const int ZC_ENTER_PC = 0xC1D; // Size: 333
		public const int ZC_ENTER_MONSTER = 0xC1E; // Size: 0
		public const int ZC_ENTER_DUMMYPC = 0xC1F; // Size: 300
		public const int ZC_UPDATED_DUMMYPC = 0xC20; // Size: 258
		...
		public const int ZC_SET_POS = 0xC2F; // Size: 22
		public const int ZC_FILE_MOVE = 0xC30; // Size: 46
		public const int CZ_LEAVE_TO_DUNGEON = 0xC31; // Size: 10
		public const int ZC_UPDATED_PCAPPEARANCE = 0xC32; // Size: 258
		...
		public const int ZC_BUFF_REMOVE = 0xC45; // Size: 17
		...
		public const int CZ_ON_AIR = 0xC66; // Size: 10
		public const int CZ_ON_GROUND = 0xC67; // Size: 10
		public const int CZ_MOVEMENT_INFO = 0xC68; // Size: 23
		public const int CZ_SKILL_TARGET = 0xC69; // Size: 19
		public const int CZ_SKILL_TARGET_ANI = 0xC6A; // Size: 23
		public const int CZ_SKILL_GROUND = 0xC6B; // Size: 61
		public const int CZ_SKILL_SELF = 0xC6C; // Size: 35
		public const int CZ_SKILL_CANCEL = 0xC6D; // Size: 11
		public const int CZ_HOLD = 0xC6E; // Size: 11
		public const int CZ_ROTATE = 0xC6F; // Size: 18
		public const int CZ_HEAD_ROTATE = 0xC70; // Size: 18
		public const int CZ_TARGET_ROTATE = 0xC71; // Size: 18
		public const int CZ_POSE = 0xC72; // Size: 34
		public const int CZ_CHAT = 0xC73; // Size: 0
		public const int CZ_CHAT_LOG = 0xC74; // Size: 0
		public const int CZ_SHOUT = 0xC75; // Size: 0
		public const int CZ_ITEM_DROP = 0xC76; // Size: 22
		public const int CZ_ITEM_DELETE = 0xC77; // Size: 0
		public const int CZ_ITEM_USE = 0xC78; // Size: 22
		public const int CZ_ITEM_USE_TO_ITEM = 0xC79; // Size: 30
		public const int CZ_ITEM_USE_TO_GROUND = 0xC7A; // Size: 30
		public const int CZ_ITEM_BUY = 0xC7B; // Size: 0
		public const int CZ_ITEM_SELL = 0xC7C; // Size: 0
		public const int CZ_ITEM_EQUIP = 0xC7D; // Size: 19
		public const int CZ_ITEM_UNEQUIP = 0xC7E; // Size: 11
		public const int ZC_CHECK_INVINDEX = 0xC7F; // Size: 30
		public const int ZC_ITEM_INVENTORY_LIST = 0xC80; // Size: 0
		public const int ZC_ITEM_INVENTORY_INDEX_LIST = 0xC81; // Size: 0
		public const int ZC_ITEM_EQUIP_LIST = 0xC82; // Size: 0
		public const int ZC_ITEM_ADD = 0xC83; // Size: 0
		public const int ZC_ITEM_REMOVE = 0xC84; // Size: 20
		public const int ZC_ITEM_USE = 0xC85; // Size: 14
		public const int ZC_ITEM_USE_TO_GROUND = 0xC86; // Size: 22
		public const int ZC_QUICK_SLOT_LIST = 0xC87; // Size: 0
		public const int ZC_SKILL_LIST = 0xC88; // Size: 0
		public const int ZC_SKILL_ADD = 0xC89; // Size: 0
		public const int ZC_ABILITY_LIST = 0xC8A; // Size: 0
		public const int CZ_ACTIVE_ABILITY = 0xC8B; // Size: 15
		public const int ZC_ACTIVE_ABILITY = 0xC8C; // Size: 11
		public const int CZ_REQ_OPEN_ITEM_DUNGEON = 0xC8D; // Size: 19
		public const int CZ_ANSWER_OPEN_ITEM_DUNGEON = 0xC8E; // Size: 19
		public const int CZ_SEND_ITEM_PROP_TO_ALCHMIST = 0xC8F; // Size: 28
		public const int CZ_EXCUTE_ITEM_DUNGEON = 0xC90; // Size: 34
		public const int ZC_RECIVE_ITEM_PROP_TO_TARGET = 0xC91; // Size: 0
		public const int CZ_DISPEL_DEBUFF_TOGGLE = 0xC92; // Size: 14
		public const int CZ_JUNGTAN_TOGGLE = 0xC93; // Size: 16
		public const int ZC_EXP_UP = 0xC94; // Size: 14
		public const int ZC_EXP_UP_BY_MONSTER = 0xC95; // Size: 18
		public const int ZC_PC_LEVELUP = 0xC96; // Size: 14
		public const int ZC_PC_STAT_AVG = 0xC97; // Size: 30
		public const int ZC_MAX_EXP_CHANGED = 0xC98; // Size: 18
		public const int ZC_TEXT = 0xC99; // Size: 0
		public const int ZC_UPDATE_SP = 0xC9A; // Size: 15
		public const int ZC_RESTORATION = 0xC9B; // Size: 12
		public const int ZC_UPDATE_MHP = 0xC9C; // Size: 14
		...
		public const int ZC_DIALOG_CLOSE = 0xCA5; // Size: 6
		public const int ZC_DIALOG_TRADE = 0xCA6; // Size: 39
		public const int ZC_DIALOG_COMMON_TRADE = 0xCA7; // Size: 39
		...
		public const int ZC_PLAY_SOUND = 0xCAC; // Size: 15
		public const int ZC_STOP_SOUND = 0xCAD; // Size: 14
		public const int ZC_PLAY_MUSICQUEUE = 0xCAE; // Size: 14
		public const int ZC_STOP_MUSICQUEUE = 0xCAF; // Size: 14
		public const int ZC_PLAY_ANI = 0xCB0; // Size: 24
		public const int ZC_CHANGE_ANI = 0xCB1; // Size: 44
		public const int CZ_MOVE_CAMP = 0xCB2; // Size: 18
		public const int CZ_CAMPINFO = 0xCB3; // Size: 18
		public const int ZC_CAMPINFO = 0xCB4; // Size: 18
		public const int ZC_FIX_ANIM = 0xCB5; // Size: 14
		public const int CZ_TARGET_JOB_INFO = 0xCB6; // Size: 18
		public const int ZC_TARGET_JOB_INFO = 0xCB7; // Size: 14
		public const int ZC_MOVE_ANIM = 0xCB8; // Size: 12
		public const int ZC_STD_ANIM = 0xCB9; // Size: 11
		public const int ZC_PLAY_ALARMSOUND = 0xCBB; // Size: 83
		public const int ZC_STOP_ALARMSOUND = 0xCBC; // Size: 10
		public const int ZC_PLAY_EXP_TEXT = 0xCBD; // Size: 14
		public const int ZC_PLAY_NAVI_EFFECT = 0xCBE; // Size: 150
		public const int ZC_UPDATE_ALL_STATUS = 0xCBF; // Size: 26
		public const int ZC_OBJECT_PROPERTY = 0xCC0; // Size: 0
		public const int ZC_DUMP_PROPERTY = 0xCC1; // Size: 0
		public const int ZC_SHOUT = 0xCC2; // Size: 0
		public const int ZC_SHOUT_FAILED = 0xCC3; // Size: 7
		public const int CZ_EXCHANGE_REQUEST = 0xCC4; // Size: 14
		public const int ZC_EXCHANGE_REQUEST_ACK = 0xCC5; // Size: 72
		public const int ZC_EXCHANGE_REQUEST_RECEIVED = 0xCC6; // Size: 71
		public const int CZ_EXCHANGE_ACCEPT = 0xCC7; // Size: 10
		public const int CZ_EXCHANGE_DECLINE = 0xCC8; // Size: 10
		public const int ZC_EXCHANGE_DECLINE_ACK = 0xCC9; // Size: 6
		public const int ZC_EXCHANGE_START = 0xCCA; // Size: 71
		public const int CZ_EXCHANGE_OFFER = 0xCCB; // Size: 30
		public const int ZC_EXCHANGE_OFFER_ACK = 0xCCC; // Size: 0
		public const int CZ_EXCHANGE_AGREE = 0xCCD; // Size: 10
		public const int ZC_EXCHANGE_AGREE_ACK = 0xCCE; // Size: 7
		public const int CZ_EXCHANGE_FINALAGREE = 0xCCF; // Size: 10
		public const int ZC_EXCHANGE_FINALAGREE_ACK = 0xCD0; // Size: 7
		public const int CZ_EXCHANGE_CANCEL = 0xCD1; // Size: 10
		public const int ZC_EXCHANGE_CANCEL_ACK = 0xCD2; // Size: 6
		public const int ZC_EXCHANGE_SUCCESS = 0xCD3; // Size: 6
		public const int ZC_COOLDOWN_LIST = 0xCD4; // Size: 0
		public const int ZC_COOLDOWN_CHANGED = 0xCD5; // Size: 22
		public const int ZC_OVERHEAT_CHANGED = 0xCD6; // Size: 26
		public const int ZC_TEST_AGENT = 0xCD7; // Size: 18
		public const int CZ_COMMON_SHOP_LIST = 0xCD8; // Size: 10
		public const int ZC_COMMON_SHOP_LIST = 0xCD9; // Size: 8
		public const int ZC_TIME_FACTOR = 0xCDA; // Size: 10
		public const int CZ_PLAY_HISTORY = 0xCDB; // Size: 19
		public const int CZ_HISTORY_ROLL_BACK = 0xCDC; // Size: 271
		public const int ZC_PARTY_ENTER = 0xCDD; // Size: 0
		public const int ZC_PARTY_OUT = 0xCDE; // Size: 24
		public const int ZC_PARTY_DESTROY = 0xCDF; // Size: 15
		public const int ZC_PARTY_INFO = 0xCE0; // Size: 0
		public const int ZC_PARTY_LIST = 0xCE1; // Size: 0
		public const int ZC_PARTY_CHAT = 0xCE2; // Size: 0
		public const int ZC_PARTY_INST_INFO = 0xCE3; // Size: 0
		public const int ZC_CHANGE_EQUIP_DURABILITY = 0xCE4; // Size: 11
		public const int CZ_DIALOG_TX = 0xCE5; // Size: 0
		public const int CZ_REQ_RECIPE = 0xCE6; // Size: 0
		public const int ZC_CUSTOM_DIALOG = 0xCE7; // Size: 75
		public const int ZC_SESSION_OBJECTS = 0xCE8; // Size: 0
		public const int ZC_SESSION_OBJ_ADD = 0xCE9; // Size: 0
		public const int ZC_SESSION_OBJ_REMOVE = 0xCEA; // Size: 10
		public const int ZC_SESSION_OBJ_TIME = 0xCEB; // Size: 14
		public const int CZ_S_OBJ_VALUE_C = 0xCEC; // Size: 24
		public const int CZ_REQ_NORMAL_TX = 0xCED; // Size: 45
		public const int ZC_COMMANDER_LOADER_INFO = 0xCEE; // Size: 0
		public const int ZC_MOVE_SINGLE_ZONE = 0xCEF; // Size: 18
		public const int ZC_BACKTO_ORIGINAL_SERVER = 0xCF0; // Size: 8
		public const int CZ_BACKTO_ORIGINAL_SERVER = 0xCF1; // Size: 12
		public const int CZ_REQ_NORMAL_TX_NUMARG = 0xCF2; // Size: 0
		public const int ZC_WIKI_LIST = 0xCF3; // Size: 0
		public const int ZC_WIKI_ADD = 0xCF4; // Size: 22
		public const int CZ_WIKI_GET = 0xCF5; // Size: 14
		public const int CZ_WIKI_RECIPE_UPDATE = 0xCF6; // Size: 10
		public const int ZC_UI_OPEN = 0xCF7; // Size: 39
		public const int ZC_ENABLE_CONTROL = 0xCF8; // Size: 11
		public const int ZC_CHANGE_CAMERA = 0xCF9; // Size: 31
		public const int ZC_MONSTER_SDR_CHANGED = 0xCFA; // Size: 11
		public const int ZC_MOVE_IGNORE_COLLISION = 0xCFB; // Size: 30
		public const int ZC_CHANGE_CAMERA_ZOOM = 0xCFC; // Size: 34
		public const int ZC_PLAY_SKILL_ANI = 0xCFD; // Size: 82
		public const int ZC_PLAY_SKILL_CAST_ANI = 0xCFE; // Size: 30
		public const int CZ_REQ_ITEM_GET = 0xCFF; // Size: 14
		public const int ZC_ITEM_GET = 0xD00; // Size: 18
		public const int CZ_GUARD = 0xD01; // Size: 19
		public const int ZC_GUARD = 0xD02; // Size: 19
		public const int ZC_STAMINA = 0xD03; // Size: 10
		public const int ZC_ADD_STAMINA = 0xD04; // Size: 10
		public const int ZC_GM_ORDER = 0xD05; // Size: 10
		public const int ZC_MYPC_ENTER = 0xD06; // Size: 18
		public const int ZC_LOCK_KEY = 0xD07; // Size: 75
		public const int ZC_SAVE_INFO = 0xD08; // Size: 6
		public const int CZ_SAVE_INFO = 0xD09; // Size: 0
		public const int ZC_OPTION_LIST = 0xD0A; // Size: 0
		public const int ZC_SKILLMAP_LIST = 0xD0B; // Size: 0
		public const int CZ_GIVEITEM_TO_DUMMYPC = 0xD0C; // Size: 22
		public const int CZ_FOOD_TABLE_TITLE = 0xD0D; // Size: 79
		public const int ZC_SET_LAYER = 0xD0E; // Size: 10
		public const int ZC_CREATE_LAYERBOX = 0xD0F; // Size: 38
		public const int ZC_RESET_BOX = 0xD10; // Size: 11
		public const int ZC_CREATE_SCROLLLOCKBOX = 0xD11; // Size: 38
		public const int ZC_REMOVE_SCROLLLOCKBOX = 0xD12; // Size: 10
		public const int CZ_DYNAMIC_CASTING_START = 0xD13; // Size: 23
		public const int CZ_DYNAMIC_CASTING_END = 0xD14; // Size: 19
		public const int CZ_SKILL_CANCEL_SCRIPT = 0xD15; // Size: 10
		public const int ZC_LEAVE_TRIGGER = 0xD16; // Size: 6
		public const int ZC_BORN = 0xD17; // Size: 10
		public const int ZC_ACHIEVE_POINT_LIST = 0xD18; // Size: 0
		public const int ZC_ACHIEVE_POINT = 0xD19; // Size: 18
		public const int CZ_ACHIEVE_EQUIP = 0xD1A; // Size: 18
		public const int ZC_ACHIEVE_EQUIP = 0xD1B; // Size: 22
		public const int CZ_CHANGE_CONFIG = 0xD1C; // Size: 18
		public const int CZ_CHANGE_CONFIG_STR = 0xD1D; // Size: 34
		public const int ZC_WORLD_MSG = 0xD1E; // Size: 43
		public const int ZC_ENABLE_SHOW_ITEM_GET = 0xD1F; // Size: 8
		public const int ZC_LOGIN_TIME = 0xD20; // Size: 14
		public const int ZC_GIVE_EXP_TO_PC = 0xD21; // Size: 42
		public const int ZC_LAYER_PC_LIST = 0xD22; // Size: 0
		public const int ZC_LAYER_PC_SOBJ_PROP = 0xD23; // Size: 0
		public const int CZ_CUSTOM_COMMAND = 0xD24; // Size: 26
		public const int ZC_LAYER_INFO = 0xD25; // Size: 10
		public const int CZ_CHAT_MACRO = 0xD26; // Size: 146
		public const int ZC_CHAT_MACRO_LIST = 0xD27; // Size: 0
		public const int ZC_RULLET_LIST = 0xD28; // Size: 0
		public const int ZC_QUICKSLOT_REGISTER = 0xD29; // Size: 46
		public const int CZ_QUICKSLOT_LIST = 0xD2A; // Size: 0
		public const int CZ_DOUBLE_ITEM_EQUIP = 0xD2B; // Size: 28
		public const int ZC_TRICK_PACKET = 0xD2C; // Size: 0
		public const int ZC_COOLDOWN_RATE = 0xD2D; // Size: 22
		public const int ZC_MAP_REVEAL_LIST = 0xD2E; // Size: 0
		public const int CZ_MAP_REVEAL_INFO = 0xD2F; // Size: 146
		public const int CZ_MAP_SEARCH_INFO = 0xD30; // Size: 55
		public const int ZC_UI_INFO_LIST = 0xD31; // Size: 0
		public const int ZC_EXEC_CLIENT_SCP = 0xD32; // Size: 0
		public const int ZC_SET_NPC_STATE = 0xD33; // Size: 18
		public const int ZC_NPC_STATE_LIST = 0xD34; // Size: 0
		public const int CZ_QUEST_NPC_STATE_CHECK = 0xD35; // Size: 14
		public const int ZC_RANK_ACHIEVE_ADD = 0xD36; // Size: 14
		public const int CZ_GET_MAP_REVEAL_ACHIEVE = 0xD37; // Size: 10
		...
		public const int ZC_SPRAY_ID = 0xD4D; // Size: 18
		public const int ZC_SPRAY_DRAW_INFO = 0xD4E; // Size: 0
		public const int ZC_MONSTER_LIFETIME = 0xD4F; // Size: 14
		public const int ZC_SPRAY_LIKE_LIST = 0xD50; // Size: 0
		public const int ZC_WIKI_COUNT_UPDATE = 0xD51; // Size: 19
		public const int ZC_WIKI_INT_PROP_UPDATE = 0xD52; // Size: 15
		public const int ZC_WIKI_BOOL_PROP_UPDATE = 0xD53; // Size: 12
		public const int CZ_REQ_WIKI_RANK = 0xD54; // Size: 15
		public const int ZC_WIKI_RANK_LIST = 0xD55; // Size: 0
		public const int ZC_SHARED_MSG = 0xD56; // Size: 10
		public const int CZ_REQ_WIKI_PROP_RANK = 0xD57; // Size: 16
		public const int CZ_GET_WIKI_REWARD = 0xD58; // Size: 11
		public const int CZ_REQ_TX_ITEM = 0xD59; // Size: 0
		public const int ZC_TEST_DBG = 0xD5A; // Size: 0
		public const int ZC_MONSTER_DIST = 0xD5B; // Size: 0
		public const int ZC_RESET_SKILL_FORCEID = 0xD5C; // Size: 10
		public const int ZC_EMOTICON = 0xD5D; // Size: 18
		public const int ZC_SHOW_EMOTICON = 0xD5E; // Size: 18
		public const int ZC_TREASUREMARK_BY_MAP = 0xD5F; // Size: 0
		public const int ZC_SHOW_MAP = 0xD60; // Size: 0
		public const int CZ_FLEE_OBSTACLE = 0xD61; // Size: 26
		public const int ZC_HOLD_MOVE_PATH = 0xD62; // Size: 11
		public const int ZC_ENTER_HOOK = 0xD63; // Size: 10
		public const int ZC_LEAVE_HOOK = 0xD64; // Size: 10
		public const int ZC_MONSTER_PROPERTY = 0xD65; // Size: 0
		public const int ZC_GROUND_EFFECT = 0xD66; // Size: 50
		public const int ZC_FLY = 0xD67; // Size: 18
		public const int ZC_FLY_MATH = 0xD68; // Size: 22
		public const int ZC_FLY_HEIGHT = 0xD69; // Size: 14
		public const int ZC_UPDATE_SHIELD = 0xD6A; // Size: 14
		public const int ZC_SHOW_MODEL = 0xD6B; // Size: 15
		public const int ZC_SKILL_RANGE_DBG = 0xD6C; // Size: 58
		public const int ZC_SKILL_RANGE_FAN = 0xD6D; // Size: 40
		public const int ZC_SKILL_RANGE_SQUARE = 0xD6E; // Size: 40
		public const int ZC_SKILL_RANGE_CIRCLE = 0xD6F; // Size: 28
		public const int ZC_SKILL_RANGE_DONUTS = 0xD70; // Size: 32
		public const int ZC_TEAMID = 0xD71; // Size: 11
		public const int ZC_PC = 0xD72; // Size: 0
		public const int CZ_LOG = 0xD73; // Size: 0
		public const int ZC_MOTIONBLUR = 0xD74; // Size: 11
		public const int ZC_PLAY_FORCE = 0xD75; // Size: 78
		public const int ZC_CAST_TARGET = 0xD76; // Size: 14
		public const int ZC_START_INFO = 0xD77; // Size: 0
		public const int ZC_JOB_EXP_UP = 0xD78; // Size: 10
		public const int ZC_JOB_PTS = 0xD79; // Size: 10
		public const int ZC_MON_STAMINA = 0xD7A; // Size: 22
		public const int CZ_CUSTOM_SCP = 0xD7B; // Size: 14
		public const int ZC_VIEW_FOCUS = 0xD7C; // Size: 24
		public const int ZC_HARDCODED_SKILL = 0xD7D; // Size: 26
		public const int CZ_HARDCODED_SKILL = 0xD7E; // Size: 34
		public const int ZC_FORCE_MOVE = 0xD7F; // Size: 30
		public const int ZC_HSKILL_CONTROL = 0xD80; // Size: 22
		public const int ZC_CANCEL_DEADEVENT = 0xD81; // Size: 10
		public const int ZC_ACTION_PKS = 0xD82; // Size: 35
		public const int CZ_HARDCODED_ITEM = 0xD83; // Size: 22
		public const int CZ_CANCEL_TRANSFORM_SKILL = 0xD84; // Size: 10
		public const int CZ_BRIQUET = 0xD85; // Size: 30
		public const int ZC_VIBRATE = 0xD86; // Size: 30
		public const int ZC_COUNTER_MOVE = 0xD87; // Size: 10
		public const int CZ_COUNTER_ATTACK = 0xD88; // Size: 14
		public const int CZ_CLIENT_DIRECT = 0xD89; // Size: 30
		public const int ZC_CLIENT_DIRECT = 0xD8A; // Size: 30
		public const int ZC_OWNER = 0xD8B; // Size: 14
		public const int ZC_GD_RANK = 0xD8C; // Size: 10
		public const int CZ_RUN_BGEVENT = 0xD8D; // Size: 74
		public const int ZC_ADD_SKILL_EFFECT = 0xD8E; // Size: 18
		public const int ZC_ITEM_DROPABLE = 0xD8F; // Size: 10
		public const int CZ_ITEM_DROP_TO_OBJECT = 0xD90; // Size: 26
		public const int ZC_NORMAL = 0xD91; // Size: 0
		public const int CZ_G_QUEST_CHECK = 0xD92; // Size: 14
		public const int ZC_MOVE_PATH_MATH = 0xD93; // Size: 30
		public const int CZ_MYPAGE_COMMENT_ADD = 0xD94; // Size: 278
		public const int CZ_MYPAGE_COMMENT_DELETE = 0xD95; // Size: 18
		public const int CZ_GUESTPAGE_COMMENT_ADD = 0xD96; // Size: 278
		public const int CZ_GET_TARGET_MYPAGE = 0xD97; // Size: 14
		public const int CZ_ON_MYPAGE_MODE = 0xD98; // Size: 14
		public const int CZ_RESET_SOCIAL_MODE = 0xD99; // Size: 10
		public const int CZ_GET_TARGET_GUESTPAGE = 0xD9A; // Size: 14
		public const int CZ_ADD_SELLMODE_ITEM = 0xD9B; // Size: 30
		public const int CZ_DELETE_SELLMODE_ITEM = 0xD9C; // Size: 18
		public const int CZ_ON_SELLITEM_MODE = 0xD9D; // Size: 14
		public const int ZC_MYPAGE_MAP = 0xD9E; // Size: 0
		public const int ZC_GUESTPAGE_MAP = 0xD9F; // Size: 0
		public const int ZC_ON_MYPAGE_MODE = 0xDA0; // Size: 0
		public const int ZC_RESET_SOCIAL_MODE = 0xDA1; // Size: 10
		public const int CZ_ON_ITEMBUY_MODE = 0xDA2; // Size: 0
		public const int ZC_ON_BUYITEM_MODE = 0xDA3; // Size: 0
		public const int ZC_SHOW_GROUND_ITEM_MARK = 0xDA4; // Size: 30
		public const int ZC_HELP_LIST = 0xDA5; // Size: 0
		public const int ZC_HELP_ADD = 0xDA6; // Size: 11
		public const int CZ_CLIENT_HIT_LIST = 0xDA7; // Size: 0
		public const int ZC_PC_ATKSTATE = 0xDA8; // Size: 11
		public const int ZC_SEND_PREMIUM_STATE = 0xDA9; // Size: 8
		public const int CZ_HELP_READ_TYPE = 0xDAA; // Size: 18
		public const int CZ_MOVE_PATH_END = 0xDAB; // Size: 10
		public const int ZC_COLL_DAMAGE = 0xDAC; // Size: 11
		public const int CZ_KEYBOARD_BEAT = 0xDAD; // Size: 10
		public const int CZ_MOVEHIT_SCP = 0xDAE; // Size: 22
		public const int ZC_SYNC_START = 0xDAF; // Size: 10
		public const int ZC_SYNC_END = 0xDB0; // Size: 14
		public const int ZC_SYNC_EXEC = 0xDB1; // Size: 10
		public const int ZC_SYNC_EXEC_BY_SKILL_TIME = 0xDB2; // Size: 18
		public const int CZ_STOP_TIMEACTION = 0xDB3; // Size: 11
		public const int CZ_REQ_DUMMYPC_INFO = 0xDB4; // Size: 18
		public const int CZ_VISIT_BARRACK = 0xDB5; // Size: 74
		public const int CZ_SPC_SKILL_POS = 0xDB6; // Size: 22
		public const int CZ_REQ_CHANGEJOB = 0xDB7; // Size: 14
		public const int CZ_CHANGE_HEAD = 0xDB8; // Size: 14
		public const int CZ_CREATE_ARROW_CRAFT = 0xDB9; // Size: 14
		public const int CZ_REQ_MINITEXT = 0xDBA; // Size: 266
		public const int ZC_PC_MOVE_STOP = 0xDBB; // Size: 35
		public const int CZ_STOP_ALLPC = 0xDBC; // Size: 10
		public const int CZ_COMPLETE_PRELOAD = 0xDBD; // Size: 14
		public const int CZ_MGAME_JOIN_CMD = 0xDBE; // Size: 46
		public const int CZ_ADD_HELP = 0xDBF; // Size: 14
		public const int ZC_ATTACH_TO_OBJ = 0xDC0; // Size: 49
		public const int ZC_DETACH_FROM_OBJ = 0xDC1; // Size: 14
		public const int ZC_RUN_FROM = 0xDC2; // Size: 14
		public const int ZC_LOOKAT_OBJ = 0xDC3; // Size: 14
		public const int CZ_SKILL_CELL_LIST = 0xDC4; // Size: 0
		public const int CZ_SKILL_TOOL_GROUND_POS = 0xDC5; // Size: 26
		public const int CZ_DIRECTION_PROCESS = 0xDC6; // Size: 18
		public const int CZ_DIRECTION_MOVE_STATE = 0xDC7; // Size: 0
		public const int ZC_TO_ALL_CLIENT = 0xDC8; // Size: 0
		public const int ZC_TO_CLIENT = 0xDC9; // Size: 0
		public const int CZ_REWARD_CMD = 0xDCA; // Size: 14
		public const int CZ_PROPERTY_COMPARE = 0xDCB; // Size: 16
		public const int ZC_PROPERTY_COMPARE = 0xDCC; // Size: 0
		public const int ZC_FACTION = 0xDCD; // Size: 14
		public const int ZC_SEND_CASH_VALUE = 0xDCE; // Size: 0
		public const int ZC_BEGIN_KILL_LOG = 0xDCF; // Size: 6
		public const int ZC_END_KILL_LOG = 0xDD0; // Size: 6
		public const int ZC_CLEAR_KILL_LOG = 0xDD1; // Size: 6
		public const int CZ_NPC_AUCTION_CMD = 0xDD2; // Size: 30
		public const int ZC_DIRECTION_APC = 0xDD3; // Size: 26
		public const int ZC_BGMODEL_ANIM_INFO = 0xDD4; // Size: 15
		public const int ZC_ATTACH_BY_KNOCKBACK = 0xDD5; // Size: 38
		public const int CZ_OBJECT_MOVE = 0xDD6; // Size: 30
		public const int CZ_CONTROL_OBJECT_ROTATE = 0xDD7; // Size: 22
		public const int CZ_SUMMON_COMMAND = 0xDD8; // Size: 18
		public const int CZ_VEHICLE_RIDE = 0xDD9; // Size: 15
		public const int CZ_REQ_WIKI_CATEGORY_RANK_PAGE_INFO = 0xDDA; // Size: 78
		public const int CZ_REQ_ACHIEVE_RANK_PAGE_INFO = 0xDDB; // Size: 78
		public const int CZ_REQ_MONSTER_RANK_INFO = 0xDDC; // Size: 74
		public const int ZC_SPC_TRIGGER_EXEC = 0xDDD; // Size: 30
		public const int CZ_REQ_MGAME_VIEW = 0xDDE; // Size: 18
		public const int CZ_REQ_MGAME_CHAT = 0xDDF; // Size: 0
		public const int CZ_TOURNAMENT_GIFT = 0xDE0; // Size: 18
		public const int CZ_PARTY_INVITE_ACCEPT = 0xDE1; // Size: 79
		public const int CZ_PARTY_INVITE_CANCEL = 0xDE2; // Size: 83
		public const int CZ_PARTY_PROP_CHANGE = 0xDE3; // Size: 145
		public const int CZ_REQ_MARKET_REGISTER = 0xDE4; // Size: 39
		public const int CZ_REQ_MARKET_BUY = 0xDE5; // Size: 0
		public const int CZ_REQ_MARKET_LIST = 0xDE6; // Size: 162
		public const int CZ_REQ_MY_SELL_LIST = 0xDE7; // Size: 14
		public const int CZ_REQ_CABINET_LIST = 0xDE8; // Size: 10
		public const int CZ_REQ_GET_CABINET_ITEM = 0xDE9; // Size: 26
		public const int CZ_REQ_CANCEL_MARKET_ITEM = 0xDEA; // Size: 18
		public const int CZ_INV_ITEM_LOCK = 0xDEB; // Size: 19
		public const int CZ_OBJ_RECORD_POS = 0xDEC; // Size: 0
		public const int CZ_FORMATION_CMD = 0xDED; // Size: 32
		public const int CZ_REGISTER_AUTOSELLER = 0xDEE; // Size: 0
		public const int CZ_OPEN_AUTOSELLER = 0xDEF; // Size: 34
		public const int CZ_BUY_AUTOSELLER_ITEMS = 0xDF0; // Size: 0
		public const int CZ_SELL_MY_AUTOSELLER_ITEMS = 0xDF1; // Size: 0
		public const int CZ_PUZZLE_CRAFT = 0xDF2; // Size: 0
		public const int CZ_PET_EQUIP = 0xDF3; // Size: 30
		public const int ZC_FOUND_PARTY_LIST = 0xDF4; // Size: 0
		public const int ZC_NEAR_PARTY_LIST = 0xDF5; // Size: 0
		public const int ZC_RECOMMEND_PARTY_INFO = 0xDF6; // Size: 0
		public const int CZ_REQUEST_SOME_PARTY = 0xDF7; // Size: 90
		public const int CZ_REFRESH_MEMBERRECOMMEND_LIST = 0xDF8; // Size: 10
		public const int ZC_TO_SOMEWHERE_CLIENT = 0xDF9; // Size: 0
		public const int CZ_REVEAL_NPC_STATE = 0xDFA; // Size: 14
		public const int CZ_CHANGE_CHANNEL = 0xDFB; // Size: 12
		public const int CZ_REQ_CHANNEL_TRAFFICS = 0xDFC; // Size: 12
		public const int CZ_BUY_PROPERTYSHOP_ITEM = 0xDFD; // Size: 0
		public const int CZ_SKILL_USE_HEIGHT = 0xDFE; // Size: 14
		public const int CZ_ACCEPT_PARTY_QUEST = 0xDFF; // Size: 20
		public const int CZ_ACCEPT_GUILD_EVENT = 0xE00; // Size: 20
		public const int CZ_ACCEPT_GUILD_EVENT_RAID = 0xE01; // Size: 20
		public const int CZ_ACCEPT_PARTY_EVENT = 0xE02; // Size: 20
		public const int CZ_DELETE_PARTY_EVENT = 0xE03; // Size: 20
		public const int CZ_PING = 0xE04; // Size: 10
		public const int ZC_PING = 0xE05; // Size: 10
		...
		public const int CZ_HIT_MISSILE = 0xE0D; // Size: 14
		public const int CZ_I_NEED_PARTY = 0xE0E; // Size: 23
		public const int CZ_PARTY_JOIN_BY_LINK = 0xE0F; // Size: 19
		public const int ZC_RECOMMEND_PARTYMEMBER_INFO = 0xE10; // Size: 0
		public const int CZ_PVP_ZONE_CMD = 0xE11; // Size: 22
		public const int CZ_PVP_CHAT = 0xE12; // Size: 0
		public const int CZ_CARDBATTLE_CMD = 0xE13; // Size: 26
		public const int CZ_REQ_UPDATE_CONTENTS_SESSION = 0xE14; // Size: 10
		public const int CZ_REQ_FRIENDLY_FIGHT = 0xE15; // Size: 15
		public const int CZ_HARDSKILL_POS_LIST = 0xE16; // Size: 0
		...
		public const int CZ_CHECK_PING = 0xE1E; // Size: 10
		...
		static Op()
		{
			...
			_sizes[Op.CZ_PLAY_HISTORY] = 19;
			_sizes[Op.CZ_HISTORY_ROLL_BACK] = 271;
			...
			_sizes[Op.CZ_EXTEND_WAREHOUSE] = 10;
			...
			_sizes[Op.CZ_REQ_MARKET_REGISTER] = 39;
