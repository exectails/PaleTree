...
namespace PaleTree.Shared
{
	public static class Op
	{
		...
		public const int CZ_REQ_CHECK_FREE_TP_TIME = 0xC8F; // Size: 10
		public const int CZ_ANSWER_OPEN_ITEM_DUNGEON = 0xC90; // Size: 19
		public const int CZ_SEND_ITEM_PROP_TO_ALCHMIST = 0xC91; // Size: 28
		public const int CZ_EXCUTE_ITEM_DUNGEON = 0xC92; // Size: 34
		public const int ZC_RECIVE_ITEM_PROP_TO_TARGET = 0xC93; // Size: 0
		public const int CZ_DISPEL_DEBUFF_TOGGLE = 0xC94; // Size: 14
		public const int CZ_JUNGTAN_TOGGLE = 0xC95; // Size: 16
		public const int ZC_EXP_UP = 0xC96; // Size: 14
		public const int ZC_EXP_UP_BY_MONSTER = 0xC97; // Size: 18
		public const int ZC_PC_LEVELUP = 0xC98; // Size: 14
		public const int ZC_PC_STAT_AVG = 0xC99; // Size: 30
		public const int ZC_MAX_EXP_CHANGED = 0xC9A; // Size: 18
		public const int ZC_TEXT = 0xC9B; // Size: 0
		public const int ZC_UPDATE_SP = 0xC9C; // Size: 15
		public const int ZC_RESTORATION = 0xC9D; // Size: 12
		public const int ZC_UPDATE_MHP = 0xC9E; // Size: 14
		public const int CZ_DIALOG_ACK = 0xC9F; // Size: 14
		public const int CZ_DIALOG_SELECT = 0xCA0; // Size: 11
		public const int CZ_DIALOG_STRINGINPUT = 0xCA1; // Size: 138
		public const int ZC_DIALOG_OK = 0xCA3; // Size: 0
		public const int ZC_DIALOG_NEXT = 0xCA4; // Size: 0
		public const int ZC_DIALOG_SELECT = 0xCA5; // Size: 0
		public const int ZC_DIALOG_ITEM_SELECT = 0xCA6; // Size: 0
		public const int ZC_DIALOG_CLOSE = 0xCA7; // Size: 6
		public const int ZC_DIALOG_TRADE = 0xCA8; // Size: 39
		public const int ZC_DIALOG_COMMON_TRADE = 0xCA9; // Size: 39
		public const int ZC_DIALOG_NUMBERRANGE = 0xCAA; // Size: 0
		public const int ZC_DIALOG_STRINGINPUT = 0xCAB; // Size: 0
		public const int ZC_ADDON_MSG = 0xCAC; // Size: 0
		public const int CZ_UI_EVENT = 0xCAD; // Size: 0
		public const int ZC_PLAY_SOUND = 0xCAE; // Size: 15
		public const int ZC_STOP_SOUND = 0xCAF; // Size: 14
		public const int ZC_PLAY_MUSICQUEUE = 0xCB0; // Size: 14
		public const int ZC_STOP_MUSICQUEUE = 0xCB1; // Size: 14
		public const int ZC_PLAY_ANI = 0xCB2; // Size: 24
		public const int ZC_CHANGE_ANI = 0xCB3; // Size: 44
		public const int CZ_MOVE_CAMP = 0xCB4; // Size: 18
		public const int CZ_CAMPINFO = 0xCB5; // Size: 18
		public const int ZC_CAMPINFO = 0xCB6; // Size: 18
		public const int ZC_FIX_ANIM = 0xCB7; // Size: 14
		public const int CZ_TARGET_JOB_INFO = 0xCB8; // Size: 18
		public const int ZC_TARGET_JOB_INFO = 0xCB9; // Size: 14
		public const int ZC_MOVE_ANIM = 0xCBA; // Size: 12
		public const int ZC_STD_ANIM = 0xCBB; // Size: 11
		public const int ZC_PLAY_ALARMSOUND = 0xCBD; // Size: 83
		public const int ZC_STOP_ALARMSOUND = 0xCBE; // Size: 10
		public const int ZC_PLAY_EXP_TEXT = 0xCBF; // Size: 14
		public const int ZC_PLAY_NAVI_EFFECT = 0xCC0; // Size: 150
		public const int ZC_UPDATE_ALL_STATUS = 0xCC1; // Size: 26
		public const int ZC_OBJECT_PROPERTY = 0xCC2; // Size: 0
		public const int ZC_DUMP_PROPERTY = 0xCC3; // Size: 0
		public const int ZC_SHOUT = 0xCC4; // Size: 0
		public const int ZC_SHOUT_FAILED = 0xCC5; // Size: 7
		public const int CZ_EXCHANGE_REQUEST = 0xCC6; // Size: 14
		public const int ZC_EXCHANGE_REQUEST_ACK = 0xCC7; // Size: 72
		public const int ZC_EXCHANGE_REQUEST_RECEIVED = 0xCC8; // Size: 71
		public const int CZ_EXCHANGE_ACCEPT = 0xCC9; // Size: 10
		public const int CZ_EXCHANGE_DECLINE = 0xCCA; // Size: 10
		public const int ZC_EXCHANGE_DECLINE_ACK = 0xCCB; // Size: 6
		public const int ZC_EXCHANGE_START = 0xCCC; // Size: 71
		public const int CZ_EXCHANGE_OFFER = 0xCCD; // Size: 30
		public const int ZC_EXCHANGE_OFFER_ACK = 0xCCE; // Size: 0
		public const int CZ_EXCHANGE_AGREE = 0xCCF; // Size: 10
		public const int ZC_EXCHANGE_AGREE_ACK = 0xCD0; // Size: 7
		public const int CZ_EXCHANGE_FINALAGREE = 0xCD1; // Size: 10
		public const int ZC_EXCHANGE_FINALAGREE_ACK = 0xCD2; // Size: 7
		public const int CZ_EXCHANGE_CANCEL = 0xCD3; // Size: 10
		public const int ZC_EXCHANGE_CANCEL_ACK = 0xCD4; // Size: 6
		public const int ZC_EXCHANGE_SUCCESS = 0xCD5; // Size: 6
		public const int ZC_COOLDOWN_LIST = 0xCD6; // Size: 0
		public const int ZC_COOLDOWN_CHANGED = 0xCD7; // Size: 22
		public const int ZC_OVERHEAT_CHANGED = 0xCD8; // Size: 26
		public const int ZC_TEST_AGENT = 0xCD9; // Size: 18
		public const int CZ_COMMON_SHOP_LIST = 0xCDA; // Size: 10
		public const int ZC_COMMON_SHOP_LIST = 0xCDB; // Size: 8
		public const int ZC_TIME_FACTOR = 0xCDC; // Size: 10
		public const int CZ_PLAY_HISTORY = 0xCDD; // Size: 19
		public const int CZ_HISTORY_ROLL_BACK = 0xCDE; // Size: 271
		...
		public const int CZ_REQ_MARKET_REGISTER = 0xDE6; // Size: 39
		public const int CZ_REQ_MARKET_BUY = 0xDE7; // Size: 0
		public const int CZ_REQ_MARKET_LIST = 0xDE8; // Size: 162
		public const int CZ_REQ_MY_SELL_LIST = 0xDE9; // Size: 14
		public const int CZ_REQ_CABINET_LIST = 0xDEA; // Size: 10
		public const int CZ_REQ_GET_CABINET_ITEM = 0xDEB; // Size: 26
		public const int CZ_REQ_CANCEL_MARKET_ITEM = 0xDEC; // Size: 18
		public const int CZ_INV_ITEM_LOCK = 0xDED; // Size: 19
		public const int CZ_OBJ_RECORD_POS = 0xDEE; // Size: 0
		public const int CZ_FORMATION_CMD = 0xDEF; // Size: 32
		public const int CZ_REGISTER_AUTOSELLER = 0xDF0; // Size: 0
		public const int CZ_OPEN_AUTOSELLER = 0xDF1; // Size: 34
		public const int CZ_BUY_AUTOSELLER_ITEMS = 0xDF2; // Size: 0
		public const int CZ_SELL_MY_AUTOSELLER_ITEMS = 0xDF3; // Size: 0
		public const int CZ_PUZZLE_CRAFT = 0xDF4; // Size: 0
		public const int CZ_PET_EQUIP = 0xDF5; // Size: 30
		public const int ZC_FOUND_PARTY_LIST = 0xDF6; // Size: 0
		public const int ZC_NEAR_PARTY_LIST = 0xDF7; // Size: 0
		public const int ZC_RECOMMEND_PARTY_INFO = 0xDF8; // Size: 0
		public const int CZ_REQUEST_SOME_PARTY = 0xDF9; // Size: 90
		public const int CZ_REFRESH_MEMBERRECOMMEND_LIST = 0xDFA; // Size: 10
		public const int ZC_TO_SOMEWHERE_CLIENT = 0xDFB; // Size: 0
		public const int CZ_REVEAL_NPC_STATE = 0xDFC; // Size: 14
		public const int CZ_CHANGE_CHANNEL = 0xDFD; // Size: 12
		public const int CZ_REQ_CHANNEL_TRAFFICS = 0xDFE; // Size: 12
		public const int CZ_BUY_PROPERTYSHOP_ITEM = 0xDFF; // Size: 0
		public const int CZ_SKILL_USE_HEIGHT = 0xE00; // Size: 14
		public const int CZ_ACCEPT_PARTY_QUEST = 0xE01; // Size: 20
		public const int CZ_ACCEPT_GUILD_EVENT = 0xE02; // Size: 20
		public const int CZ_ACCEPT_GUILD_EVENT_RAID = 0xE03; // Size: 20
		public const int CZ_ACCEPT_PARTY_EVENT = 0xE04; // Size: 20
		public const int CZ_DELETE_PARTY_EVENT = 0xE05; // Size: 20
		public const int CZ_PING = 0xE06; // Size: 10
		public const int ZC_PING = 0xE07; // Size: 10
		...
		public const int CZ_PVP_ZONE_CMD = 0xE13; // Size: 22
		...
		static Op()
		{
			...
			_sizes[Op.CZ_REQ_CHECK_FREE_TP_TIME] = 10;
